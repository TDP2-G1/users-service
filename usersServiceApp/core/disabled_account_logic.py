...
from usersServiceApp.infra.db_disabled_account import create_disabled_account, get_user_last_account_status
...
def is_disabled(id_user):
    _disabled_account = get_user_last_account_status(id_user)
